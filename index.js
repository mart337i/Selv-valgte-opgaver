...
function dropLogs() {
    var inventory_x = 1740;
    var inventory_y = 1119;
    var inventory_log_color = "664d2a";
...
function testScreenCapture() {
    // taking a screenshot
    var img = robot.screen.capture(0, 0, 1920, 1200);
...
function findTree() {
    ...
    var tree_colors = ["92622f", "9a6933", "895e2b", "4d3212", "281905","a16927"];
...
function confirmTree(screen_x, screen_y) {
    ...
    document.write(screen_x, screen_y);
